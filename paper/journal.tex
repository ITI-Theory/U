...
\titleformat{\chapter}{\needspace{8\baselineskip}\huge\bfseries\sffamily\color{heading}}{\thechapter.}{0.5em}{}[{\color{rulecolor}\hrule height 0.6pt}]
...
% ---------------------------------------------------------------------------
% 10. Modern blockquote / callout box styling

...
% ── 9. Visible opening for each contained paper ─────────────────────────────
% Each included paper remains a complete PDF facsimile with local pagination.
\newcommand{\omnipaperdivider}[3]{%
  \thispagestyle{empty}%
  \vspace*{0.30\textheight}%
  \begin{center}%
    {\small\sffamily\color{accent}COLLECTION PAPER\par}%
    \vspace{2mm}%
    {\small\sffamily\color{accent}#1\par}%
    \vspace{8mm}%
    {\Huge\bfseries\sffamily\color{heading}#2\par}%
    \vspace{7mm}%
    {\color{rulecolor}\rule{0.72\textwidth}{0.6pt}\par}%
    \vspace{5mm}%
    {\small\sffamily\color{black!60}#3\par}%
  \end{center}%
  \addcontentsline{toc}{chapter}{#2}%
  \clearpage
}
\newcommand{\collectionblank}{\thispagestyle{empty}\null\newpage}

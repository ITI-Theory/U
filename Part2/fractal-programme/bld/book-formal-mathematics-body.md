...
```{=latex}
\includepdf{C:/Users/alist/prj/git/ITI-Theory/U/Part2/fractal-programme/bld/cheatsheet-formal-mathematics.pdf}
\tableofcontents
\clearpage
```
...
**G-ID:** *Functorial Green’s Function — category-theoretic propagator between field spaces*

...
\noindent\textit{Why:} law asks which social commitments remain stable when power and circumstance change. [T]-Theory treats rights, precedent, and institutional constraint as patterns of propagation and invariance in a collective field.
...
\vspace{1pt}\noindent{\sffamily\tiny\color{hudtext}\textcolor{white}{[} FIELD NOTES / LEGAL INFERENCE \textcolor{white}{]}\hfill\textcolor{ledorange}{[ ~ AWAITING VALIDATION ]}}\par
\vspace{2pt}\noindent\textcolor{hudline}{\rule{\textwidth}{0.25pt}}\par\vspace{2pt}\noindent{\scriptsize\color{hudtext}\raggedright \texttt{\textbf{G-ID:>}} The Rights Invariant — topological propagator for legal precedent and norm diffusion\\
\texttt{\textbf{DOMAIN:>}} law, jurisprudence, political theory, regulatory studies\\
\texttt{\textbf{READER:>}} Legal Scholar\\
\texttt{\textbf{SCALE:>}} Regulatory scales 12-14: cities, nations, and legal jurisdictions\\
\texttt{\textbf{EQUATION:>}} $\dot e = -\nabla H(e) + J_\text{law}(t) + \eta(t)$\\
\texttt{\textbf{OPERATOR:>}} Constraint operator on the legal attractor landscape}
\par\vspace{3pt}\noindent\textcolor{hudline}{\rule{\textwidth}{0.25pt}}\par\vspace{2pt}\noindent{\sffamily\tiny\color{hudtext}\textcolor{white}{[} ABDUCTING:> \textcolor{white}{]}}\par
\vspace{1pt}\noindent{\scriptsize\color{hudtext}\raggedright \texttt{\textbf{INVARIANT:>}} $\oint_\gamma \nabla R \cdot dx = n \in \mathbb{Z}$\\
\texttt{\textbf{OBSERVABLE:>}} Spectral gap of the constraint operator\\
\texttt{\textbf{PENDING:>}} \textcolor{ledorange}{[ ~ AWAITING ]} Interpretive model; legal case-study validation pending.}
\vspace{2pt}\noindent\textcolor{hudline}{\rule{\textwidth}{0.35pt}}

...
```{=latex}
\includepdf{C:/Users/alist/prj/git/ITI-Theory/U/Part2/fractal-programme/bld/cheatsheet-neuroscience.pdf}
\tableofcontents
\clearpage
```
...
**G-ID:** *The Cortical EMF Propagator — macroscopic field from synchronised neural firing*
